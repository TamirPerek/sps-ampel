class CarTrafficLight {
    ...
    draw() {
        ...
        if (this.orientation === "left") {
            ...
            fill(255, 0, 0, this.red ? 255 : 50);
            circle(this.x - this.margin, this.y - (this.margin * 2.25), this.diameter);
            fill(255, 255, 0, this.yellow ? 255 : 50);
            circle(this.x - this.margin, this.y - (this.margin * 3.25), this.diameter);
            fill(0, 255, 0, this.green ? 255 : 50);
            circle(this.x - this.margin, this.y - (this.margin * 4.25), this.diameter);
